      ...
      <div className="bg-card border border-border/60 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.02)] overflow-hidden">
        ...
        <div className="p-8">
          <form onSubmit={handleSave} className="space-y-5">
            ...
            <Input label="Email Address" defaultValue={user.email} disabled className="opacity-70" />
            ...
            <div className="pt-6 flex justify-end">
              <Button type="submit" className="shadow-md px-8 font-semibold">Save Changes</Button>
            </div>
          </form>
        </div>
      </div>
